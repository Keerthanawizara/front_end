...
export const GET_LIEN_DATA = "GET_LIEN_DATA";
export const GET_ASSESSEE_DATA = "GET_ASSESSEE_DATA";
...
export const PROPERTY_GRID = "PROPERTY_GRID";
export const LIEN_GRID = "LIEN_GRID";
export const ASSESSEE_GRID = "ASSESSEE_GRID";
